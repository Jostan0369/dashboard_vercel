  ...
  return (
    <div className="w-full">
      <div className="flex justify-center mb-4 space-x-6">
        <button className={`px-4 py-2 rounded-full ${activeMainTab==='crypto'?'bg-blue-600 text-white':'bg-gray-200'}`} onClick={()=>setActiveMainTab('crypto')}>CRYPTO</button>
        <button className={`px-4 py-2 rounded-full ${activeMainTab==='nse'?'bg-green-600 text-white':'bg-gray-200'}`} onClick={()=>setActiveMainTab('nse')}>NSE</button>
      </div>
